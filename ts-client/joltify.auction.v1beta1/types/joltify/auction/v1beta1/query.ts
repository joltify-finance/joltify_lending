...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("joltify.auction.v1beta1.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Auction(request: QueryAuctionRequest): Promise<QueryAuctionResponse> {
    const data = QueryAuctionRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.auction.v1beta1.Query", "Auction", data);
  ...
  Auctions(request: QueryAuctionsRequest): Promise<QueryAuctionsResponse> {
    ...
    const promise = this.rpc.request("joltify.auction.v1beta1.Query", "Auctions", data);
  ...
  NextAuctionID(request: QueryNextAuctionIDRequest): Promise<QueryNextAuctionIDResponse> {
    ...
    const promise = this.rpc.request("joltify.auction.v1beta1.Query", "NextAuctionID", data);
