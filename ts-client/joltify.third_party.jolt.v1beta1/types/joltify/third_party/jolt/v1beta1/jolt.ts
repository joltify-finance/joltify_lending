...
export interface MoneyMarket {
  denom: string;
  borrowLimit: BorrowLimit | undefined;
  spotMarketId: string;
  conversionFactor: string;
  interestRateModel: InterestRateModel | undefined;
...
function createBaseParams(): Params {
  return { moneyMarkets: [], minimumBorrowUsdValue: "", surplusAuctionThreshold: "" };
}
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.moneyMarkets) {
      obj.moneyMarkets = message.moneyMarkets.map((e) => e ? MoneyMarket.toJSON(e) : undefined);
    } else {
      obj.moneyMarkets = [];
    }
    message.minimumBorrowUsdValue !== undefined && (obj.minimumBorrowUsdValue = message.minimumBorrowUsdValue);
...
export const MoneyMarket = {
  ...
  toJSON(message: MoneyMarket): unknown {
    ...
    message.borrowLimit !== undefined
      && (obj.borrowLimit = message.borrowLimit ? BorrowLimit.toJSON(message.borrowLimit) : undefined);
    ...
    message.interestRateModel !== undefined && (obj.interestRateModel = message.interestRateModel
  ...
  fromPartial<I extends Exact<DeepPartial<MoneyMarket>, I>>(object: I): MoneyMarket {
    const message = createBaseMoneyMarket();
    message.denom = object.denom ?? "";
    message.borrowLimit = (object.borrowLimit !== undefined && object.borrowLimit !== null)
    ...
    message.interestRateModel = (object.interestRateModel !== undefined && object.interestRateModel !== null)
...
export const BorrowLimit = {
  ...
  toJSON(message: BorrowLimit): unknown {
    const obj: any = {};
    message.hasMaxLimit !== undefined && (obj.hasMaxLimit = message.hasMaxLimit);
    message.maximumLimit !== undefined && (obj.maximumLimit = message.maximumLimit);
    message.loanToValue !== undefined && (obj.loanToValue = message.loanToValue);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<BorrowLimit>, I>>(object: I): BorrowLimit {
    const message = createBaseBorrowLimit();
...
export const InterestRateModel = {
  ...
  toJSON(message: InterestRateModel): unknown {
    const obj: any = {};
    message.baseRateApy !== undefined && (obj.baseRateApy = message.baseRateApy);
    message.baseMultiplier !== undefined && (obj.baseMultiplier = message.baseMultiplier);
    message.kink !== undefined && (obj.kink = message.kink);
    message.jumpMultiplier !== undefined && (obj.jumpMultiplier = message.jumpMultiplier);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<InterestRateModel>, I>>(object: I): InterestRateModel {
    const message = createBaseInterestRateModel();
...
export const Deposit = {
  ...
  toJSON(message: Deposit): unknown {
    ...
    if (message.index) {
      obj.index = message.index.map((e) => e ? SupplyInterestFactor.toJSON(e) : undefined);
    } else {
      obj.index = [];
    }
    return obj;
...
export const Borrow = {
  ...
  toJSON(message: Borrow): unknown {
    ...
    if (message.index) {
      obj.index = message.index.map((e) => e ? BorrowInterestFactor.toJSON(e) : undefined);
    } else {
      obj.index = [];
    }
    return obj;
...
export const SupplyInterestFactor = {
  ...
  fromPartial<I extends Exact<DeepPartial<SupplyInterestFactor>, I>>(object: I): SupplyInterestFactor {
    const message = createBaseSupplyInterestFactor();
    message.denom = object.denom ?? "";
...
export const BorrowInterestFactor = {
  ...
  fromPartial<I extends Exact<DeepPartial<BorrowInterestFactor>, I>>(object: I): BorrowInterestFactor {
    const message = createBaseBorrowInterestFactor();
    message.denom = object.denom ?? "";
    message.value = object.value ?? "";
    return message;
