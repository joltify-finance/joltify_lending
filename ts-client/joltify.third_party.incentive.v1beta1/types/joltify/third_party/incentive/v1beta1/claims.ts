...
export interface JoltLiquidityProviderClaim {
  baseClaim: BaseMultiClaim | undefined;
...
export const BaseClaim = {
  ...
  fromPartial<I extends Exact<DeepPartial<BaseClaim>, I>>(object: I): BaseClaim {
    const message = createBaseBaseClaim();
...
export const BaseMultiClaim = {
  ...
  fromPartial<I extends Exact<DeepPartial<BaseMultiClaim>, I>>(object: I): BaseMultiClaim {
    const message = createBaseBaseMultiClaim();
    message.owner = object.owner ?? new Uint8Array();
  ...
  toJSON(message: RewardIndex): unknown {
    ...
    message.rewardFactor !== undefined
      && (obj.rewardFactor = base64FromBytes(
        message.rewardFactor !== undefined ? message.rewardFactor : new Uint8Array(),
      ));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<RewardIndex>, I>>(object: I): RewardIndex {
    const message = createBaseRewardIndex();
...
export const RewardIndexesProto = {
  ...
  fromPartial<I extends Exact<DeepPartial<RewardIndexesProto>, I>>(object: I): RewardIndexesProto {
    const message = createBaseRewardIndexesProto();
...
export const MultiRewardIndex = {
  ...
  fromPartial<I extends Exact<DeepPartial<MultiRewardIndex>, I>>(object: I): MultiRewardIndex {
    const message = createBaseMultiRewardIndex();
    message.collateralType = object.collateralType ?? "";
    message.rewardIndexes = object.rewardIndexes?.map((e) => RewardIndex.fromPartial(e)) || [];
    return message;
...
export const MultiRewardIndexesProto = {
  ...
  fromPartial<I extends Exact<DeepPartial<MultiRewardIndexesProto>, I>>(object: I): MultiRewardIndexesProto {
    const message = createBaseMultiRewardIndexesProto();
...
export const USDXMintingClaim = {
  ...
  toJSON(message: USDXMintingClaim): unknown {
    ...
    message.baseClaim !== undefined
      && (obj.baseClaim = message.baseClaim ? BaseClaim.toJSON(message.baseClaim) : undefined);
    if (message.rewardIndexes) {
      obj.rewardIndexes = message.rewardIndexes.map((e) => e ? RewardIndex.toJSON(e) : undefined);
    } else {
      obj.rewardIndexes = [];
  ...
  fromPartial<I extends Exact<DeepPartial<USDXMintingClaim>, I>>(object: I): USDXMintingClaim {
    const message = createBaseUSDXMintingClaim();
    message.baseClaim = (object.baseClaim !== undefined && object.baseClaim !== null)
...
function createBaseJoltLiquidityProviderClaim(): JoltLiquidityProviderClaim {
  return { baseClaim: undefined, supplyRewardIndexes: [], borrowRewardIndexes: [] };
}
...
export const JoltLiquidityProviderClaim = {
  ...
  fromJSON(object: any): JoltLiquidityProviderClaim {
    return {
      ...
      supplyRewardIndexes: Array.isArray(object?.supplyRewardIndexes)
        ? object.supplyRewardIndexes.map((e: any) => MultiRewardIndex.fromJSON(e))
        : [],
      borrowRewardIndexes: Array.isArray(object?.borrowRewardIndexes)
        ? object.borrowRewardIndexes.map((e: any) => MultiRewardIndex.fromJSON(e))
        : [],
    };
  },

  toJSON(message: JoltLiquidityProviderClaim): unknown {
    const obj: any = {};
    message.baseClaim !== undefined
      && (obj.baseClaim = message.baseClaim ? BaseMultiClaim.toJSON(message.baseClaim) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<JoltLiquidityProviderClaim>, I>>(object: I): JoltLiquidityProviderClaim {
    const message = createBaseJoltLiquidityProviderClaim();
    message.baseClaim = (object.baseClaim !== undefined && object.baseClaim !== null)
...
export const DelegatorClaim = {
  ...
  fromPartial<I extends Exact<DeepPartial<DelegatorClaim>, I>>(object: I): DelegatorClaim {
    const message = createBaseDelegatorClaim();
    message.baseClaim = (object.baseClaim !== undefined && object.baseClaim !== null)
      ? BaseMultiClaim.fromPartial(object.baseClaim)
      : undefined;
...
export const SwapClaim = {
  ...
  fromPartial<I extends Exact<DeepPartial<SwapClaim>, I>>(object: I): SwapClaim {
    const message = createBaseSwapClaim();
    message.baseClaim = (object.baseClaim !== undefined && object.baseClaim !== null)
      ? BaseMultiClaim.fromPartial(object.baseClaim)
      : undefined;
...
export const SavingsClaim = {
  ...
  fromPartial<I extends Exact<DeepPartial<SavingsClaim>, I>>(object: I): SavingsClaim {
    const message = createBaseSavingsClaim();
    message.baseClaim = (object.baseClaim !== undefined && object.baseClaim !== null)
      ? BaseMultiClaim.fromPartial(object.baseClaim)
      : undefined;
