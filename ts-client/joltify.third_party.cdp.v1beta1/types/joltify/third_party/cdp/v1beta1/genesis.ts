...
export const protobufPackage = "joltify.third_party.cdp.v1beta1";
...
export interface Params {
  ...
  debtParam: DebtParam | undefined;
  globalDebtLimit: Coin | undefined;
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.startingCdpId = longToNumber(reader.uint64() as Long);
          break;
        case 5:
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      startingCdpId: isSet(object.startingCdpId) ? Number(object.startingCdpId) : 0,
      debtDenom: isSet(object.debtDenom) ? String(object.debtDenom) : "",
      govDenom: isSet(object.govDenom) ? String(object.govDenom) : "",
      previousAccumulationTimes: Array.isArray(object?.previousAccumulationTimes)
        ? object.previousAccumulationTimes.map((e: any) => GenesisAccumulationTime.fromJSON(e))
        : [],
      totalPrincipals: Array.isArray(object?.totalPrincipals)
        ? object.totalPrincipals.map((e: any) => GenesisTotalPrincipal.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.startingCdpId !== undefined && (obj.startingCdpId = Math.round(message.startingCdpId));
    ...
    if (message.previousAccumulationTimes) {
      obj.previousAccumulationTimes = message.previousAccumulationTimes.map((e) =>
        e ? GenesisAccumulationTime.toJSON(e) : undefined
      );
    } else {
      obj.previousAccumulationTimes = [];
    }
    if (message.totalPrincipals) {
      obj.totalPrincipals = message.totalPrincipals.map((e) => e ? GenesisTotalPrincipal.toJSON(e) : undefined);
    } else {
      obj.totalPrincipals = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.startingCdpId = object.startingCdpId ?? 0;
    message.debtDenom = object.debtDenom ?? "";
    message.govDenom = object.govDenom ?? "";
    message.previousAccumulationTimes =
      object.previousAccumulationTimes?.map((e) => GenesisAccumulationTime.fromPartial(e)) || [];
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.collateralParams) {
      obj.collateralParams = message.collateralParams.map((e) => e ? CollateralParam.toJSON(e) : undefined);
    } else {
      obj.collateralParams = [];
    }
    message.debtParam !== undefined
      && (obj.debtParam = message.debtParam ? DebtParam.toJSON(message.debtParam) : undefined);
    message.globalDebtLimit !== undefined
      && (obj.globalDebtLimit = message.globalDebtLimit ? Coin.toJSON(message.globalDebtLimit) : undefined);
    message.surplusAuctionThreshold !== undefined && (obj.surplusAuctionThreshold = message.surplusAuctionThreshold);
    message.surplusAuctionLot !== undefined && (obj.surplusAuctionLot = message.surplusAuctionLot);
    message.debtAuctionThreshold !== undefined && (obj.debtAuctionThreshold = message.debtAuctionThreshold);
    message.debtAuctionLot !== undefined && (obj.debtAuctionLot = message.debtAuctionLot);
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.debtParam = (object.debtParam !== undefined && object.debtParam !== null)
      ? DebtParam.fromPartial(object.debtParam)
      : undefined;
    message.globalDebtLimit = (object.globalDebtLimit !== undefined && object.globalDebtLimit !== null)
...
export const DebtParam = {
  ...
  toJSON(message: DebtParam): unknown {
    ...
    message.referenceAsset !== undefined && (obj.referenceAsset = message.referenceAsset);
  ...
  fromPartial<I extends Exact<DeepPartial<DebtParam>, I>>(object: I): DebtParam {
    const message = createBaseDebtParam();
...
export const CollateralParam = {
  ...
  toJSON(message: CollateralParam): unknown {
    ...
    message.debtLimit !== undefined && (obj.debtLimit = message.debtLimit ? Coin.toJSON(message.debtLimit) : undefined);
    message.stabilityFee !== undefined && (obj.stabilityFee = message.stabilityFee);
    message.auctionSize !== undefined && (obj.auctionSize = message.auctionSize);
    message.liquidationPenalty !== undefined && (obj.liquidationPenalty = message.liquidationPenalty);
    message.spotMarketId !== undefined && (obj.spotMarketId = message.spotMarketId);
    message.liquidationMarketId !== undefined && (obj.liquidationMarketId = message.liquidationMarketId);
    message.keeperRewardPercentage !== undefined && (obj.keeperRewardPercentage = message.keeperRewardPercentage);
    message.checkCollateralizationIndexCount !== undefined
      && (obj.checkCollateralizationIndexCount = message.checkCollateralizationIndexCount);
    message.conversionFactor !== undefined && (obj.conversionFactor = message.conversionFactor);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CollateralParam>, I>>(object: I): CollateralParam {
    const message = createBaseCollateralParam();
    message.denom = object.denom ?? "";
    message.type = object.type ?? "";
    message.liquidationRatio = object.liquidationRatio ?? "";
    message.debtLimit = (object.debtLimit !== undefined && object.debtLimit !== null)
...
function createBaseGenesisAccumulationTime(): GenesisAccumulationTime {
  return { collateralType: "", previousAccumulationTime: undefined, interestFactor: "" };
}
...
export const GenesisAccumulationTime = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisAccumulationTime>, I>>(object: I): GenesisAccumulationTime {
    const message = createBaseGenesisAccumulationTime();
...
export const GenesisTotalPrincipal = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisTotalPrincipal>, I>>(object: I): GenesisTotalPrincipal {
    const message = createBaseGenesisTotalPrincipal();
    message.collateralType = object.collateralType ?? "";
