...
function createBaseDeposit(): Deposit {
  return { cdpId: 0, depositor: "", amount: undefined };
}
...
export const Deposit = {
  ...
  fromJSON(object: any): Deposit {
    return {
      cdpId: isSet(object.cdpId) ? Number(object.cdpId) : 0,
...
export const TotalPrincipal = {
  ...
  fromPartial<I extends Exact<DeepPartial<TotalPrincipal>, I>>(object: I): TotalPrincipal {
    const message = createBaseTotalPrincipal();
...
export const OwnerCDPIndex = {
        ...
        case 1:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.cdpIds.push(longToNumber(reader.uint64() as Long));
            }
          } else {
            message.cdpIds.push(longToNumber(reader.uint64() as Long));
          }
  ...
  fromJSON(object: any): OwnerCDPIndex {
    return { cdpIds: Array.isArray(object?.cdpIds) ? object.cdpIds.map((e: any) => Number(e)) : [] };
  },

  toJSON(message: OwnerCDPIndex): unknown {
    const obj: any = {};
    if (message.cdpIds) {
      obj.cdpIds = message.cdpIds.map((e) => Math.round(e));
    } else {
      obj.cdpIds = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<OwnerCDPIndex>, I>>(object: I): OwnerCDPIndex {
    const message = createBaseOwnerCDPIndex();
    message.cdpIds = object.cdpIds?.map((e) => e) || [];
    return message;
  },
};
