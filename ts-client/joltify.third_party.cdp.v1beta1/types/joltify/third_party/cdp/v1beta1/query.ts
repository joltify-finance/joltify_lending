...
import { Deposit, TotalCollateral, TotalPrincipal } from "./cdp";
...
export interface CDPResponse {
  ...
  accumulatedFees: Coin | undefined;
  feesUpdated: Date | undefined;
  interestFactor: string;
  collateralValue: Coin | undefined;
...
export const QueryCdpRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCdpRequest>, I>>(object: I): QueryCdpRequest {
    const message = createBaseQueryCdpRequest();
...
export const QueryCdpResponse = {
  ...
  fromJSON(object: any): QueryCdpResponse {
    return { cdp: isSet(object.cdp) ? CDPResponse.fromJSON(object.cdp) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCdpResponse>, I>>(object: I): QueryCdpResponse {
    const message = createBaseQueryCdpResponse();
...
function createBaseQueryCdpsRequest(): QueryCdpsRequest {
  return { collateralType: "", owner: "", id: 0, ratio: "", pagination: undefined };
}
...
export const QueryCdpsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCdpsRequest>, I>>(object: I): QueryCdpsRequest {
    const message = createBaseQueryCdpsRequest();
    message.collateralType = object.collateralType ?? "";
    message.owner = object.owner ?? "";
...
export const QueryCdpsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCdpsResponse>, I>>(object: I): QueryCdpsResponse {
    const message = createBaseQueryCdpsResponse();
...
export const QueryDepositsResponse = {
  ...
  fromJSON(object: any): QueryDepositsResponse {
    return { deposits: Array.isArray(object?.deposits) ? object.deposits.map((e: any) => Deposit.fromJSON(e)) : [] };
  },
...
export const QueryTotalPrincipalRequest = {
  ...
  fromJSON(object: any): QueryTotalPrincipalRequest {
    return { collateralType: isSet(object.collateralType) ? String(object.collateralType) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTotalPrincipalRequest>, I>>(object: I): QueryTotalPrincipalRequest {
    const message = createBaseQueryTotalPrincipalRequest();
    message.collateralType = object.collateralType ?? "";
    return message;
  },
...
export const QueryTotalPrincipalResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTotalPrincipalResponse>, I>>(object: I): QueryTotalPrincipalResponse {
    const message = createBaseQueryTotalPrincipalResponse();
...
export const QueryTotalCollateralRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTotalCollateralRequest>, I>>(object: I): QueryTotalCollateralRequest {
    const message = createBaseQueryTotalCollateralRequest();
    message.collateralType = object.collateralType ?? "";
    return message;
  },
...
export const QueryTotalCollateralResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTotalCollateralResponse>, I>>(object: I): QueryTotalCollateralResponse {
    const message = createBaseQueryTotalCollateralResponse();
...
export const CDPResponse = {
  ...
  toJSON(message: CDPResponse): unknown {
    ...
    message.accumulatedFees !== undefined
      && (obj.accumulatedFees = message.accumulatedFees ? Coin.toJSON(message.accumulatedFees) : undefined);
    ...
    message.collateralValue !== undefined
      && (obj.collateralValue = message.collateralValue ? Coin.toJSON(message.collateralValue) : undefined);
    message.collateralizationRatio !== undefined && (obj.collateralizationRatio = message.collateralizationRatio);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CDPResponse>, I>>(object: I): CDPResponse {
    const message = createBaseCDPResponse();
    message.id = object.id ?? 0;
    message.owner = object.owner ?? "";
    ...
    message.principal = (object.principal !== undefined && object.principal !== null)
      ...
      : undefined;
    message.accumulatedFees = (object.accumulatedFees !== undefined && object.accumulatedFees !== null)
    ...
    message.collateralValue = (object.collateralValue !== undefined && object.collateralValue !== null)
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Accounts(request: QueryAccountsRequest): Promise<QueryAccountsResponse> {
    const data = QueryAccountsRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "Accounts", data);
    return promise.then((data) => QueryAccountsResponse.decode(new _m0.Reader(data)));
  }

  TotalPrincipal(request: QueryTotalPrincipalRequest): Promise<QueryTotalPrincipalResponse> {
    const data = QueryTotalPrincipalRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "TotalPrincipal", data);
  ...
  TotalCollateral(request: QueryTotalCollateralRequest): Promise<QueryTotalCollateralResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "TotalCollateral", data);
  ...
  Cdps(request: QueryCdpsRequest): Promise<QueryCdpsResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "Cdps", data);
    return promise.then((data) => QueryCdpsResponse.decode(new _m0.Reader(data)));
  }

  Cdp(request: QueryCdpRequest): Promise<QueryCdpResponse> {
    const data = QueryCdpRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "Cdp", data);
    return promise.then((data) => QueryCdpResponse.decode(new _m0.Reader(data)));
  }

  Deposits(request: QueryDepositsRequest): Promise<QueryDepositsResponse> {
    const data = QueryDepositsRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Query", "Deposits", data);
