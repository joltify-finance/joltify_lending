...
function createBaseMsgCreateCDP(): MsgCreateCDP {
  return { sender: "", collateral: undefined, principal: undefined, collateralType: "" };
}
...
export const MsgCreateCDP = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateCDP>, I>>(object: I): MsgCreateCDP {
    const message = createBaseMsgCreateCDP();
...
export const MsgCreateCDPResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateCDPResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.cdpId = longToNumber(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): MsgCreateCDPResponse {
    return { cdpId: isSet(object.cdpId) ? Number(object.cdpId) : 0 };
  },

  toJSON(message: MsgCreateCDPResponse): unknown {
    const obj: any = {};
    message.cdpId !== undefined && (obj.cdpId = Math.round(message.cdpId));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgCreateCDPResponse>, I>>(object: I): MsgCreateCDPResponse {
    const message = createBaseMsgCreateCDPResponse();
    message.cdpId = object.cdpId ?? 0;
    return message;
  },
};

function createBaseMsgDeposit(): MsgDeposit {
  return { depositor: "", owner: "", collateral: undefined, collateralType: "" };
}
...
export const MsgDrawDebt = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDrawDebt>, I>>(object: I): MsgDrawDebt {
    const message = createBaseMsgDrawDebt();
    message.sender = object.sender ?? "";
    message.collateralType = object.collateralType ?? "";
    message.principal = (object.principal !== undefined && object.principal !== null)
...
export const MsgDrawDebtResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDrawDebtResponse>, I>>(_: I): MsgDrawDebtResponse {
    const message = createBaseMsgDrawDebtResponse();
    return message;
  },
};
...
export const MsgRepayDebt = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRepayDebt>, I>>(object: I): MsgRepayDebt {
    const message = createBaseMsgRepayDebt();
    message.sender = object.sender ?? "";
    message.collateralType = object.collateralType ?? "";
...
export const MsgRepayDebtResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRepayDebtResponse>, I>>(_: I): MsgRepayDebtResponse {
    const message = createBaseMsgRepayDebtResponse();
    return message;
  },
};
...
export const MsgLiquidateResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgLiquidateResponse>, I>>(_: I): MsgLiquidateResponse {
    const message = createBaseMsgLiquidateResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  CreateCDP(request: MsgCreateCDP): Promise<MsgCreateCDPResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "CreateCDP", data);
    return promise.then((data) => MsgCreateCDPResponse.decode(new _m0.Reader(data)));
  }

  Deposit(request: MsgDeposit): Promise<MsgDepositResponse> {
    const data = MsgDeposit.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "Deposit", data);
    return promise.then((data) => MsgDepositResponse.decode(new _m0.Reader(data)));
  }

  Withdraw(request: MsgWithdraw): Promise<MsgWithdrawResponse> {
    const data = MsgWithdraw.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "Withdraw", data);
    return promise.then((data) => MsgWithdrawResponse.decode(new _m0.Reader(data)));
  }

  DrawDebt(request: MsgDrawDebt): Promise<MsgDrawDebtResponse> {
    const data = MsgDrawDebt.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "DrawDebt", data);
    return promise.then((data) => MsgDrawDebtResponse.decode(new _m0.Reader(data)));
  }

  RepayDebt(request: MsgRepayDebt): Promise<MsgRepayDebtResponse> {
    const data = MsgRepayDebt.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "RepayDebt", data);
    return promise.then((data) => MsgRepayDebtResponse.decode(new _m0.Reader(data)));
  }

  Liquidate(request: MsgLiquidate): Promise<MsgLiquidateResponse> {
    const data = MsgLiquidate.encode(request).finish();
    const promise = this.rpc.request("joltify.third_party.cdp.v1beta1.Msg", "Liquidate", data);
