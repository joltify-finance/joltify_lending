...
export const protobufPackage = "joltify.jolt.v1beta1";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Accounts(request: QueryAccountsRequest): Promise<QueryAccountsResponse> {
    const data = QueryAccountsRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "Accounts", data);
    return promise.then((data) => QueryAccountsResponse.decode(new _m0.Reader(data)));
  }

  Deposits(request: QueryDepositsRequest): Promise<QueryDepositsResponse> {
    const data = QueryDepositsRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "Deposits", data);
  ...
  UnsyncedDeposits(request: QueryUnsyncedDepositsRequest): Promise<QueryUnsyncedDepositsResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "UnsyncedDeposits", data);
  ...
  TotalDeposited(request: QueryTotalDepositedRequest): Promise<QueryTotalDepositedResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "TotalDeposited", data);
  ...
  Borrows(request: QueryBorrowsRequest): Promise<QueryBorrowsResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "Borrows", data);
  ...
  UnsyncedBorrows(request: QueryUnsyncedBorrowsRequest): Promise<QueryUnsyncedBorrowsResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "UnsyncedBorrows", data);
  ...
  TotalBorrowed(request: QueryTotalBorrowedRequest): Promise<QueryTotalBorrowedResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "TotalBorrowed", data);
  ...
  InterestRate(request: QueryInterestRateRequest): Promise<QueryInterestRateResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "InterestRate", data);
  ...
  Reserves(request: QueryReservesRequest): Promise<QueryReservesResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "Reserves", data);
  ...
  InterestFactors(request: QueryInterestFactorsRequest): Promise<QueryInterestFactorsResponse> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "InterestFactors", data);
  ...
  liquidate(request: QueryLiquidateRequest): Promise<QueryLiquidateResp> {
    ...
    const promise = this.rpc.request("joltify.jolt.v1beta1.Query", "liquidate", data);
