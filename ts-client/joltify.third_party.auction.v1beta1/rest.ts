 ...
 */
export type V1Beta1MsgPlaceBidResponse = object;
...
export interface V1Beta1Params {
  ...
  forward_bid_duration?: string;
  reverse_bid_duration?: string;
 ...
 */
export interface V1Beta1QueryAuctionResponse {
  /**
   * `Any` contains an arbitrary serialized protocol buffer message along with a
   * URL that describes the type of the serialized message.
   *
 ...
 */
export interface V1Beta1QueryAuctionsResponse {
 ...
 */
export interface V1Beta1QueryNextAuctionIDResponse {
  /** @format uint64 */
  id?: string;
}
...
/**
 * @title joltify/third_party/auction/v1beta1/auction.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryAuctions
   * @summary Auctions queries auctions filtered by asset denom, owner address, phase, and auction type
   * @request GET:/joltify/auction/v1beta1/auctions
   */
  queryAuctions = (
    query?: {
      type?: string;
    ...
    this.request<V1Beta1QueryAuctionsResponse, RpcStatus>({
      path: `/joltify/auction/v1beta1/auctions`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/joltify/auction/v1beta1/auctions/{auction_id}
   */
  queryAuction = (auctionId: string, params: RequestParams = {}) =>
    this.request<V1Beta1QueryAuctionResponse, RpcStatus>({
      path: `/joltify/auction/v1beta1/auctions/${auctionId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/joltify/auction/v1beta1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1Beta1QueryParamsResponse, RpcStatus>({
      path: `/joltify/auction/v1beta1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
