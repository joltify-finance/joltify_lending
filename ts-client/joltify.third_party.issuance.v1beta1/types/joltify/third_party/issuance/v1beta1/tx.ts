...
export const protobufPackage = "joltify.third_party.issuance.v1beta1";
...
export const MsgIssueTokens = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgIssueTokens>, I>>(object: I): MsgIssueTokens {
    const message = createBaseMsgIssueTokens();
...
export const MsgIssueTokensResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgIssueTokensResponse>, I>>(_: I): MsgIssueTokensResponse {
    const message = createBaseMsgIssueTokensResponse();
    return message;
  },
};
...
export const MsgRedeemTokens = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRedeemTokens>, I>>(object: I): MsgRedeemTokens {
    const message = createBaseMsgRedeemTokens();
    message.sender = object.sender ?? "";
    message.tokens = (object.tokens !== undefined && object.tokens !== null)
      ? Coin.fromPartial(object.tokens)
...
export const MsgRedeemTokensResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRedeemTokensResponse>, I>>(_: I): MsgRedeemTokensResponse {
    const message = createBaseMsgRedeemTokensResponse();
    return message;
  },
};
...
export const MsgBlockAddress = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgBlockAddress>, I>>(object: I): MsgBlockAddress {
    const message = createBaseMsgBlockAddress();
    message.sender = object.sender ?? "";
...
export const MsgBlockAddressResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgBlockAddressResponse>, I>>(_: I): MsgBlockAddressResponse {
    const message = createBaseMsgBlockAddressResponse();
    return message;
  },
};
...
export const MsgUnblockAddress = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUnblockAddress>, I>>(object: I): MsgUnblockAddress {
    const message = createBaseMsgUnblockAddress();
    message.sender = object.sender ?? "";
    message.denom = object.denom ?? "";
    message.blockedAddress = object.blockedAddress ?? "";
...
export const MsgUnblockAddressResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUnblockAddressResponse>, I>>(_: I): MsgUnblockAddressResponse {
    const message = createBaseMsgUnblockAddressResponse();
    return message;
  },
};
...
export const MsgSetPauseStatus = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSetPauseStatus>, I>>(object: I): MsgSetPauseStatus {
    const message = createBaseMsgSetPauseStatus();
    message.sender = object.sender ?? "";
    message.denom = object.denom ?? "";
...
export const MsgSetPauseStatusResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSetPauseStatusResponse>, I>>(_: I): MsgSetPauseStatusResponse {
    const message = createBaseMsgSetPauseStatusResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  IssueTokens(request: MsgIssueTokens): Promise<MsgIssueTokensResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.issuance.v1beta1.Msg", "IssueTokens", data);
  ...
  RedeemTokens(request: MsgRedeemTokens): Promise<MsgRedeemTokensResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.issuance.v1beta1.Msg", "RedeemTokens", data);
  ...
  BlockAddress(request: MsgBlockAddress): Promise<MsgBlockAddressResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.issuance.v1beta1.Msg", "BlockAddress", data);
  ...
  UnblockAddress(request: MsgUnblockAddress): Promise<MsgUnblockAddressResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.issuance.v1beta1.Msg", "UnblockAddress", data);
  ...
  SetPauseStatus(request: MsgSetPauseStatus): Promise<MsgSetPauseStatusResponse> {
    ...
    const promise = this.rpc.request("joltify.third_party.issuance.v1beta1.Msg", "SetPauseStatus", data);
