...
export interface V1Beta1RateLimit {
  active?: boolean;
...
/**
 * @title joltify/third_party/issuance/v1beta1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/joltify/third_party/issuance/v1beta1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1Beta1QueryParamsResponse, RpcStatus>({
      path: `/joltify/third_party/issuance/v1beta1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
