...
export const createRPCMsgClient = async ({
  ...
  joltify: {
    spv: new (await import("./spv/tx.rpc.msg")).MsgClientImpl(rpc),
    third_party: {
      auction: {
        v1beta1: new (await import("./third_party/auction/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      cdp: {
        v1beta1: new (await import("./third_party/cdp/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      incentive: {
        v1beta1: new (await import("./third_party/incentive/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      issuance: {
        v1beta1: new (await import("./third_party/issuance/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      jolt: {
        v1beta1: new (await import("./third_party/jolt/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      pricefeed: {
        v1beta1: new (await import("./third_party/pricefeed/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
      }
    },
