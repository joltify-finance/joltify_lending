...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/params`;
  ...
  async price(params: QueryPriceRequest): Promise<QueryPriceResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/prices/${params.marketId}`;
  ...
  async prices(_params: QueryPricesRequest = {}): Promise<QueryPricesResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/prices`;
  ...
  async rawPrices(params: QueryRawPricesRequest): Promise<QueryRawPricesResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/rawprices/${params.marketId}`;
  ...
  async oracles(params: QueryOraclesRequest): Promise<QueryOraclesResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/oracles/${params.marketId}`;
  ...
  async markets(_params: QueryMarketsRequest = {}): Promise<QueryMarketsResponseSDKType> {
    const endpoint = `joltify/third_party/pricefeed/v1beta1/markets`;
