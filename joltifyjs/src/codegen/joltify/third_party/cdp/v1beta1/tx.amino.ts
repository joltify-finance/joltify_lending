...
export interface MsgCreateCDPAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgCreateCDP";
  value: {
    sender: string;
    collateral: {
      denom: string;
...
export interface MsgDepositAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgDeposit";
  value: {
    depositor: string;
    owner: string;
    collateral: {
...
export interface MsgWithdrawAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgWithdraw";
  value: {
    depositor: string;
    owner: string;
    collateral: {
...
export interface MsgDrawDebtAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgDrawDebt";
  value: {
    sender: string;
    collateral_type: string;
    principal: {
...
export interface MsgRepayDebtAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgRepayDebt";
  value: {
    sender: string;
    collateral_type: string;
    payment: {
...
export interface MsgLiquidateAminoType extends AminoMsg {
  type: "/joltify.third_party.cdp.v1beta1.MsgLiquidate";
  value: {
    keeper: string;
    borrower: string;
    collateral_type: string;
...
export const AminoConverter = {
  "/joltify.third_party.cdp.v1beta1.MsgCreateCDP": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgCreateCDP",
    toAmino: ({
      sender,
      collateral,
      principal,
  ...
  "/joltify.third_party.cdp.v1beta1.MsgDeposit": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgDeposit",
    toAmino: ({
      depositor,
      owner,
      collateral,
  ...
  "/joltify.third_party.cdp.v1beta1.MsgWithdraw": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgWithdraw",
    toAmino: ({
      depositor,
      owner,
      collateral,
  ...
  "/joltify.third_party.cdp.v1beta1.MsgDrawDebt": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgDrawDebt",
    toAmino: ({
      sender,
      collateralType,
      principal
  ...
  "/joltify.third_party.cdp.v1beta1.MsgRepayDebt": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgRepayDebt",
    toAmino: ({
      sender,
      collateralType,
      payment
  ...
  "/joltify.third_party.cdp.v1beta1.MsgLiquidate": {
    aminoType: "/joltify.third_party.cdp.v1beta1.MsgLiquidate",
    toAmino: ({
      keeper,
      borrower,
      collateralType
