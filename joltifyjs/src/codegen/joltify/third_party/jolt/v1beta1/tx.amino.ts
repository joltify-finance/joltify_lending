...
export interface MsgDepositAminoType extends AminoMsg {
  type: "/joltify.third_party.jolt.v1beta1.MsgDeposit";
  value: {
    depositor: string;
    amount: {
      denom: string;
...
export interface MsgWithdrawAminoType extends AminoMsg {
  type: "/joltify.third_party.jolt.v1beta1.MsgWithdraw";
  value: {
    depositor: string;
    amount: {
      denom: string;
...
export interface MsgBorrowAminoType extends AminoMsg {
  type: "/joltify.third_party.jolt.v1beta1.MsgBorrow";
  value: {
    borrower: string;
    amount: {
      denom: string;
...
export interface MsgRepayAminoType extends AminoMsg {
  type: "/joltify.third_party.jolt.v1beta1.MsgRepay";
  value: {
    sender: string;
    owner: string;
    amount: {
...
export interface MsgLiquidateAminoType extends AminoMsg {
  type: "/joltify.third_party.jolt.v1beta1.MsgLiquidate";
  value: {
    keeper: string;
    borrower: string;
  };
...
export const AminoConverter = {
  "/joltify.third_party.jolt.v1beta1.MsgDeposit": {
    aminoType: "/joltify.third_party.jolt.v1beta1.MsgDeposit",
    toAmino: ({
      depositor,
      amount
  ...
  "/joltify.third_party.jolt.v1beta1.MsgWithdraw": {
    aminoType: "/joltify.third_party.jolt.v1beta1.MsgWithdraw",
    toAmino: ({
      depositor,
      amount
  ...
  "/joltify.third_party.jolt.v1beta1.MsgBorrow": {
    aminoType: "/joltify.third_party.jolt.v1beta1.MsgBorrow",
    toAmino: ({
      borrower,
      amount
  ...
  "/joltify.third_party.jolt.v1beta1.MsgRepay": {
    aminoType: "/joltify.third_party.jolt.v1beta1.MsgRepay",
    toAmino: ({
      sender,
      owner,
      amount
  ...
  "/joltify.third_party.jolt.v1beta1.MsgLiquidate": {
    aminoType: "/joltify.third_party.jolt.v1beta1.MsgLiquidate",
    toAmino: ({
      keeper,
      borrower
