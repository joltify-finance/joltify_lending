...
export const createLCDClient = async ({
  ...
  return {
    ...
    joltify: {
      ...
      spv: new (await import("./spv/query.lcd")).LCDQueryClient({
        requestClient
      }),
      third_party: {
        auction: {
          v1beta1: new (await import("./third_party/auction/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        cdp: {
          v1beta1: new (await import("./third_party/cdp/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        issuance: {
          v1beta1: new (await import("./third_party/issuance/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        jolt: {
          v1beta1: new (await import("./third_party/jolt/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        pricefeed: {
          v1beta1: new (await import("./third_party/pricefeed/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        }
      },
