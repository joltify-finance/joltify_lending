...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    joltify: {
      ...
      spv: (await import("./spv/query.rpc.Query")).createRpcQueryExtension(client),
      third_party: {
        auction: {
          v1beta1: (await import("./third_party/auction/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        cdp: {
          v1beta1: (await import("./third_party/cdp/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        issuance: {
          v1beta1: (await import("./third_party/issuance/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        jolt: {
          v1beta1: (await import("./third_party/jolt/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        pricefeed: {
          v1beta1: (await import("./third_party/pricefeed/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        }
      },
