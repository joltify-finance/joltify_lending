...
import (
	...
	"github.com/joltify-finance/joltify_lending/app/prepare"
...
func (app *App) setupUpgradeHandlers() {
	...
	for _, subspace := range app.ParamsKeeper.GetSubspaces() {
		...
		case authtypes.ModuleName:
			keyTable = authtypes.ParamKeyTable() //nolint
		case banktypes.ModuleName:
			keyTable = banktypes.ParamKeyTable() //nolint
		case stakingtypes.ModuleName:
			keyTable = stakingtypes.ParamKeyTable() //nolint
		case minttypes.ModuleName:
			keyTable = minttypes.ParamKeyTable()
		case distrtypes.ModuleName:
			keyTable = distrtypes.ParamKeyTable() //nolint
		case slashingtypes.ModuleName:
			keyTable = slashingtypes.ParamKeyTable() //nolint
		case govtypes.ModuleName:
			keyTable = govv1.ParamKeyTable() //nolint
		case crisistypes.ModuleName:
			keyTable = crisistypes.ParamKeyTable() //nolint
