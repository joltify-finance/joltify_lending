...
var (
	makerOrder     = v1.OrderToIndexerOrder(constants.Order_Alice_Num0_Id0_Clob0_Buy5_Price10_GTB15)
	takerOrder     = v1.OrderToIndexerOrder(constants.Order_Alice_Num0_Id2_Clob1_Sell5_Price10_GTB15)
	OrderFillEvent = indexerevents.OrderFillEventV1{
...
var (
	subaccountId       = v1.SubaccountIdToIndexerSubaccountId(constants.Alice_Num0)
	perpetualPositions = v1.PerpetualPositionsToIndexerPerpetualPositions(
...
var (
	Alice_Num0_IndexerSubaccountId = v1.SubaccountIdToIndexerSubaccountId(constants.Alice_Num0)
	Alice_Num1_IndexerSubaccountId = v1.SubaccountIdToIndexerSubaccountId(constants.Alice_Num1)
	TransferEvent                  = indexerevents.TransferEventV1{
