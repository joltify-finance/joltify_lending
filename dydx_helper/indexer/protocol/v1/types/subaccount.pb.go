...
// source: joltify/third_party/dydxprotocol/indexer/protocol/v1/subaccount.proto
...
func (*IndexerSubaccountId) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c88255e602bc7e5, []int{0}
}
...
type IndexerPerpetualPosition struct {
	...
	FundingPayment github_com_joltify_finance_joltify_lending_dydx_helper_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/joltify-finance/joltify_lending/dydx_helper/dtypes.SerializableInt" json:"funding_payment"`
}
...
func (*IndexerPerpetualPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c88255e602bc7e5, []int{1}
}
...
func (*IndexerAssetPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c88255e602bc7e5, []int{2}
}
...
func init() {
	proto.RegisterType((*IndexerSubaccountId)(nil), "joltify.third_party.dydxprotocol.indexer.protocol.v1.IndexerSubaccountId")
	proto.RegisterType((*IndexerPerpetualPosition)(nil), "joltify.third_party.dydxprotocol.indexer.protocol.v1.IndexerPerpetualPosition")
	proto.RegisterType((*IndexerAssetPosition)(nil), "joltify.third_party.dydxprotocol.indexer.protocol.v1.IndexerAssetPosition")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/indexer/protocol/v1/subaccount.proto", fileDescriptor_0c88255e602bc7e5)
}

var fileDescriptor_0c88255e602bc7e5 = []byte{
	// 446 bytes of a gzipped FileDescriptorProto
	,
}
