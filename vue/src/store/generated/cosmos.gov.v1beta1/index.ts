...
import { WeightedVoteOption } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "joltify-finance-joltify_lending-client-ts/cosmos.gov.v1beta1/types"
