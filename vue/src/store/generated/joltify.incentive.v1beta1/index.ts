...
import { BaseClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { BaseMultiClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { RewardIndex } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { RewardIndexesProto } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MultiRewardIndex } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MultiRewardIndexesProto } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { USDXMintingClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { JoltLiquidityProviderClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { DelegatorClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { SwapClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { SavingsClaim } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { AccumulationTime } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { GenesisRewardState } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { RewardPeriod } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MultiRewardPeriod } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { Multiplier } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MultipliersPerDenom } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { Params } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { Selection } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MsgClaimUSDXMintingRewardResponse } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MsgClaimDelegatorRewardResponse } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MsgClaimSwapRewardResponse } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
import { MsgClaimSavingsRewardResponse } from "joltify-finance-joltify_lending-client-ts/joltify.incentive.v1beta1/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: joltify.incentive.v1beta1 initialized!')
		...
		async sendMsgClaimUSDXMintingReward({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.JoltifyIncentiveV1Beta1.tx.sendMsgClaimUSDXMintingReward({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
		...
		async sendMsgClaimJoltReward({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIncentiveV1Beta1.tx.sendMsgClaimJoltReward({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgClaimSavingsReward({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIncentiveV1Beta1.tx.sendMsgClaimSavingsReward({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgClaimDelegatorReward({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIncentiveV1Beta1.tx.sendMsgClaimDelegatorReward({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgClaimSwapReward({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIncentiveV1Beta1.tx.sendMsgClaimSwapReward({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgClaimUSDXMintingReward({ rootGetters }, { value }) {
			try {
				...
				const msg = await client.JoltifyIncentiveV1Beta1.tx.msgClaimUSDXMintingReward({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgClaimUSDXMintingReward:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgClaimJoltReward({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIncentiveV1Beta1.tx.msgClaimJoltReward({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgClaimJoltReward:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgClaimSavingsReward({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIncentiveV1Beta1.tx.msgClaimSavingsReward({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgClaimSavingsReward:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgClaimDelegatorReward({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIncentiveV1Beta1.tx.msgClaimDelegatorReward({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgClaimDelegatorReward:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgClaimSwapReward({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIncentiveV1Beta1.tx.msgClaimSwapReward({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgClaimSwapReward:Init Could not initialize signing client. Wallet is required.')
