...
import { Params } from "../ts-client/ethermint.evm.v1/types"
import { ChainConfig } from "../ts-client/ethermint.evm.v1/types"
import { State } from "../ts-client/ethermint.evm.v1/types"
import { TransactionLogs } from "../ts-client/ethermint.evm.v1/types"
import { Log } from "../ts-client/ethermint.evm.v1/types"
import { TxResult } from "../ts-client/ethermint.evm.v1/types"
import { AccessTuple } from "../ts-client/ethermint.evm.v1/types"
import { TraceConfig } from "../ts-client/ethermint.evm.v1/types"
import { GenesisAccount } from "../ts-client/ethermint.evm.v1/types"
import { QueryTxLogsRequest } from "../ts-client/ethermint.evm.v1/types"
import { QueryTxLogsResponse } from "../ts-client/ethermint.evm.v1/types"
import { LegacyTx } from "../ts-client/ethermint.evm.v1/types"
import { AccessListTx } from "../ts-client/ethermint.evm.v1/types"
import { DynamicFeeTx } from "../ts-client/ethermint.evm.v1/types"
import { ExtensionOptionsEthereumTx } from "../ts-client/ethermint.evm.v1/types"
	...
	actions: {
		...
		async sendMsgEthereumTx({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.EthermintEvmV1.tx.sendMsgEthereumTx({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
