...
/**
 * @title joltify/savings/v1beta1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/joltify/savings/v1beta1/deposits
   */
  queryDeposits = (
    query?: {
      denom?: string;
    ...
    this.request<V1Beta1QueryDepositsResponse, RpcStatus>({
      path: `/joltify/savings/v1beta1/deposits`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/joltify/savings/v1beta1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1Beta1QueryParamsResponse, RpcStatus>({
      path: `/joltify/savings/v1beta1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
