...
export const protobufPackage = "joltify.issuance.v1beta1";
...
export class MsgClientImpl implements Msg {
  ...
  IssueTokens(request: MsgIssueTokens): Promise<MsgIssueTokensResponse> {
    ...
    const promise = this.rpc.request("joltify.issuance.v1beta1.Msg", "IssueTokens", data);
  ...
  RedeemTokens(request: MsgRedeemTokens): Promise<MsgRedeemTokensResponse> {
    ...
    const promise = this.rpc.request("joltify.issuance.v1beta1.Msg", "RedeemTokens", data);
  ...
  BlockAddress(request: MsgBlockAddress): Promise<MsgBlockAddressResponse> {
    ...
    const promise = this.rpc.request("joltify.issuance.v1beta1.Msg", "BlockAddress", data);
  ...
  UnblockAddress(request: MsgUnblockAddress): Promise<MsgUnblockAddressResponse> {
    ...
    const promise = this.rpc.request("joltify.issuance.v1beta1.Msg", "UnblockAddress", data);
  ...
  SetPauseStatus(request: MsgSetPauseStatus): Promise<MsgSetPauseStatusResponse> {
    ...
    const promise = this.rpc.request("joltify.issuance.v1beta1.Msg", "SetPauseStatus", data);
