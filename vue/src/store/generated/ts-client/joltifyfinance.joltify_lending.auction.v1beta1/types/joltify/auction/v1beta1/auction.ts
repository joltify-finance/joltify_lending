...
export const protobufPackage = "joltifyfinance.joltify_lending.joltify.auction.v1beta1";
...
export interface DebtAuction {
  baseAuction: BaseAuction | undefined;
  correspondingDebt: Coin | undefined;
}
...
export interface CollateralAuction {
  baseAuction: BaseAuction | undefined;
  correspondingDebt: Coin | undefined;
  maxBid: Coin | undefined;
  lotReturns: WeightedAddresses | undefined;
}
...
export const SurplusAuction = {
  ...
  fromJSON(object: any): SurplusAuction {
    return { baseAuction: isSet(object.baseAuction) ? BaseAuction.fromJSON(object.baseAuction) : undefined };
  },
...
export const DebtAuction = {
  ...
  toJSON(message: DebtAuction): unknown {
    ...
    message.correspondingDebt !== undefined
      && (obj.correspondingDebt = message.correspondingDebt ? Coin.toJSON(message.correspondingDebt) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DebtAuction>, I>>(object: I): DebtAuction {
    ...
    message.baseAuction = (object.baseAuction !== undefined && object.baseAuction !== null)
      ? BaseAuction.fromPartial(object.baseAuction)
      : undefined;
    message.correspondingDebt = (object.correspondingDebt !== undefined && object.correspondingDebt !== null)
...
function createBaseCollateralAuction(): CollateralAuction {
  return { baseAuction: undefined, correspondingDebt: undefined, maxBid: undefined, lotReturns: undefined };
}
...
export const CollateralAuction = {
  ...
  toJSON(message: CollateralAuction): unknown {
    ...
    message.lotReturns !== undefined
      && (obj.lotReturns = message.lotReturns ? WeightedAddresses.toJSON(message.lotReturns) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CollateralAuction>, I>>(object: I): CollateralAuction {
    const message = createBaseCollateralAuction();
    message.baseAuction = (object.baseAuction !== undefined && object.baseAuction !== null)
      ? BaseAuction.fromPartial(object.baseAuction)
      : undefined;
    message.correspondingDebt = (object.correspondingDebt !== undefined && object.correspondingDebt !== null)
      ? Coin.fromPartial(object.correspondingDebt)
      : undefined;
    message.maxBid = (object.maxBid !== undefined && object.maxBid !== null)
      ? Coin.fromPartial(object.maxBid)
      : undefined;
    message.lotReturns = (object.lotReturns !== undefined && object.lotReturns !== null)
...
export const WeightedAddresses = {
  ...
  fromPartial<I extends Exact<DeepPartial<WeightedAddresses>, I>>(object: I): WeightedAddresses {
    const message = createBaseWeightedAddresses();
