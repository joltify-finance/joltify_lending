...
import { MsgPlaceBid } from "./types/joltify/auction/v1beta1/tx";
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgPlaceBid({ value }: msgPlaceBidParams): EncodeObject {
			try {
				return { typeUrl: "/joltifyfinance.joltify_lending.auction.v1beta1.MsgPlaceBid", value: MsgPlaceBid.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			JoltifyfinanceJoltifyLendingAuctionV1Beta1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
