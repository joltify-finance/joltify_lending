...
export { MsgWithdraw, MsgLiquidate, MsgCreateCDP, MsgDeposit, MsgRepayDebt, MsgDrawDebt };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgWithdraw({ value }: msgWithdrawParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgWithdraw", value: MsgWithdraw.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgLiquidate({ value }: msgLiquidateParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgLiquidate", value: MsgLiquidate.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateCDP({ value }: msgCreateCDPParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgCreateCDP", value: MsgCreateCDP.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeposit({ value }: msgDepositParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgDeposit", value: MsgDeposit.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgRepayDebt({ value }: msgRepayDebtParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgRepayDebt", value: MsgRepayDebt.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDrawDebt({ value }: msgDrawDebtParams): EncodeObject {
			try {
				return { typeUrl: "/joltify.cdp.v1beta1.MsgDrawDebt", value: MsgDrawDebt.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			JoltifyCdpV1Beta1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
