...
export const protobufPackage = "joltify.pricefeed.v1beta1";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Price(request: QueryPriceRequest): Promise<QueryPriceResponse> {
    const data = QueryPriceRequest.encode(request).finish();
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "Price", data);
  ...
  Prices(request: QueryPricesRequest): Promise<QueryPricesResponse> {
    ...
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "Prices", data);
  ...
  RawPrices(request: QueryRawPricesRequest): Promise<QueryRawPricesResponse> {
    ...
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "RawPrices", data);
  ...
  Oracles(request: QueryOraclesRequest): Promise<QueryOraclesResponse> {
    ...
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "Oracles", data);
  ...
  Markets(request: QueryMarketsRequest): Promise<QueryMarketsResponse> {
    ...
    const promise = this.rpc.request("joltify.pricefeed.v1beta1.Query", "Markets", data);
