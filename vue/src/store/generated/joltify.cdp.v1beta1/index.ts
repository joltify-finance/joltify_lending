...
import { CDP } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { Deposit } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { TotalPrincipal } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { TotalCollateral } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { OwnerCDPIndex } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { Params } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { DebtParam } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { CollateralParam } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { GenesisAccumulationTime } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { GenesisTotalPrincipal } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
import { CDPResponse } from "joltify-finance-joltify_lending-client-ts/joltify.cdp.v1beta1/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: joltify.cdp.v1beta1 initialized!')
		...
		async QueryParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.JoltifyCdpV1Beta1.query.queryParams()).data
		...
		async QueryAccounts({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryAccounts()).data
		...
		async QueryTotalPrincipal({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryTotalPrincipal(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyCdpV1Beta1.query.queryTotalPrincipal({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
		...
		async QueryTotalCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryTotalCollateral(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyCdpV1Beta1.query.queryTotalCollateral({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryCdps({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryCdps(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyCdpV1Beta1.query.queryCdps({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryCdp({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryCdp( key.owner,  key.collateral_type)).data
		...
		async QueryDeposits({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyCdpV1Beta1.query.queryDeposits( key.owner,  key.collateral_type)).data
		...
		async sendMsgRepayDebt({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgRepayDebt({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
		...
		async sendMsgCreateCDP({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgCreateCDP({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeposit({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgDeposit({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgLiquidate({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgLiquidate({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgWithdraw({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgWithdraw({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDrawDebt({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyCdpV1Beta1.tx.sendMsgDrawDebt({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgRepayDebt({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgRepayDebt({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRepayDebt:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgCreateCDP({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgCreateCDP({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCreateCDP:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgDeposit({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgDeposit({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgDeposit:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgLiquidate({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgLiquidate({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgLiquidate:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgWithdraw({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgWithdraw({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgWithdraw:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgDrawDebt({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyCdpV1Beta1.tx.msgDrawDebt({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgDrawDebt:Init Could not initialize signing client. Wallet is required.')
