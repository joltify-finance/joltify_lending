...
import { GenesisAccumulationTime } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { Params } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { MoneyMarket } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { BorrowLimit } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { InterestRateModel } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { Deposit } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { Borrow } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { SupplyInterestFactor } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { BorrowInterestFactor } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { CoinsProto } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { LiquidateItem } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { DepositResponse } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { SupplyInterestFactorResponse } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { BorrowResponse } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { BorrowInterestFactorResponse } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { MoneyMarketInterestRate } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
import { InterestFactor } from "joltify-finance-joltify_lending-client-ts/joltify.jolt.v1beta1/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: joltify.jolt.v1beta1 initialized!')
		...
		async QueryParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.JoltifyJoltV1Beta1.query.queryParams()).data
		...
		async QueryAccounts({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryAccounts()).data
		...
		async QueryDeposits({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryDeposits(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyJoltV1Beta1.query.queryDeposits({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
		...
		async QueryUnsyncedDeposits({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryUnsyncedDeposits(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyJoltV1Beta1.query.queryUnsyncedDeposits({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryTotalDeposited({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryTotalDeposited( key.denom)).data
		...
		async QueryBorrows({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryBorrows(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyJoltV1Beta1.query.queryBorrows({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryUnsyncedBorrows({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryUnsyncedBorrows(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyJoltV1Beta1.query.queryUnsyncedBorrows({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryTotalBorrowed({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryTotalBorrowed( key.denom)).data
		...
		async QueryInterestRate({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryInterestRate( key.denom)).data
		...
		async QueryReserves({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryReserves( key.denom)).data
		...
		async QueryInterestFactors({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryInterestFactors( key.denom)).data
		...
		async Queryliquidate({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.JoltifyJoltV1Beta1.query.queryliquidate(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.JoltifyJoltV1Beta1.query.queryliquidate({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async sendMsgLiquidate({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.JoltifyJoltV1Beta1.tx.sendMsgLiquidate({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
		...
		async sendMsgDeposit({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyJoltV1Beta1.tx.sendMsgDeposit({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgBorrow({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyJoltV1Beta1.tx.sendMsgBorrow({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgWithdraw({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyJoltV1Beta1.tx.sendMsgWithdraw({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRepay({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyJoltV1Beta1.tx.sendMsgRepay({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgLiquidate({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyJoltV1Beta1.tx.msgLiquidate({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgLiquidate:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgDeposit({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyJoltV1Beta1.tx.msgDeposit({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgDeposit:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgBorrow({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyJoltV1Beta1.tx.msgBorrow({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgBorrow:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgWithdraw({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyJoltV1Beta1.tx.msgWithdraw({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgWithdraw:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgRepay({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyJoltV1Beta1.tx.msgRepay({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRepay:Init Could not initialize signing client. Wallet is required.')
