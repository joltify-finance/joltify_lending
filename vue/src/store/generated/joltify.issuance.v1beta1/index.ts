...
import { Params } from "joltify-finance-joltify_lending-client-ts/joltify.issuance.v1beta1/types"
import { Asset } from "joltify-finance-joltify_lending-client-ts/joltify.issuance.v1beta1/types"
import { RateLimit } from "joltify-finance-joltify_lending-client-ts/joltify.issuance.v1beta1/types"
import { AssetSupply } from "joltify-finance-joltify_lending-client-ts/joltify.issuance.v1beta1/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: joltify.issuance.v1beta1 initialized!')
		...
		async QueryParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.JoltifyIssuanceV1Beta1.query.queryParams()).data
		...
		async sendMsgRedeemTokens({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.JoltifyIssuanceV1Beta1.tx.sendMsgRedeemTokens({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
		...
		async sendMsgSetPauseStatus({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIssuanceV1Beta1.tx.sendMsgSetPauseStatus({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgBlockAddress({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIssuanceV1Beta1.tx.sendMsgBlockAddress({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUnblockAddress({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIssuanceV1Beta1.tx.sendMsgUnblockAddress({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgIssueTokens({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.JoltifyIssuanceV1Beta1.tx.sendMsgIssueTokens({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgRedeemTokens({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIssuanceV1Beta1.tx.msgRedeemTokens({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRedeemTokens:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgSetPauseStatus({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIssuanceV1Beta1.tx.msgSetPauseStatus({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgSetPauseStatus:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgBlockAddress({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIssuanceV1Beta1.tx.msgBlockAddress({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgBlockAddress:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgUnblockAddress({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIssuanceV1Beta1.tx.msgUnblockAddress({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgUnblockAddress:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgIssueTokens({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.JoltifyIssuanceV1Beta1.tx.msgIssueTokens({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgIssueTokens:Init Could not initialize signing client. Wallet is required.')
