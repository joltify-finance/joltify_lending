...
// source: joltify/third_party/dydxprotocol/daemons/pricefeed/price_feed.proto
...
func (*UpdateMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5ebabbba1536725, []int{0}
}
...
func (*UpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5ebabbba1536725, []int{1}
}
...
func (*ExchangePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5ebabbba1536725, []int{2}
}
...
func (*MarketPriceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5ebabbba1536725, []int{3}
}
...
func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/daemons/pricefeed/price_feed.proto", fileDescriptor_c5ebabbba1536725)
}

var fileDescriptor_c5ebabbba1536725 = []byte{
	// 462 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *priceFeedServiceClient) UpdateMarketPrices(ctx context.Context, in *UpdateMarketPricesRequest, opts ...grpc.CallOption) (*UpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PriceFeedService_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices",
	}
...
var _PriceFeedService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "joltify/third_party/dydxprotocol/daemons/pricefeed/price_feed.proto",
}
