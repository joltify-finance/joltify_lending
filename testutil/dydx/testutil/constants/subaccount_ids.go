...
var (
	Alice_Num0 = satypes.SubaccountId{
		Owner:  types.MustBech32ifyAddressBytes(config.Bech32MainPrefix, AliceAccAddress),
		Number: 0,
	}
	...
	Bob_Num0 = satypes.SubaccountId{
		Owner:  types.MustBech32ifyAddressBytes(config.Bech32MainPrefix, BobAccAddress),
		Number: 0,
	}
	...
	Carl_Num0 = satypes.SubaccountId{
		Owner:  types.MustBech32ifyAddressBytes(config.Bech32MainPrefix, CarlAccAddress),
		Number: 0,
	}
	...
	Dave_Num0 = satypes.SubaccountId{
		Owner:  types.MustBech32ifyAddressBytes(config.Bech32MainPrefix, DaveAccAddress),
		Number: 0,
	}
