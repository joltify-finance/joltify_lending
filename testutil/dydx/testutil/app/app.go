...
import (
	...
	testlog "github.com/joltify-finance/joltify_lending/testutil/dydx/testutil/logger"
...
func prepareValidatorHomeDir(
	...
	if err = os.MkdirAll(fmt.Sprintf("%s/config/", validatorHomeDir), 0o755); err != nil {
		return "", err
	}
	if err = os.WriteFile(
