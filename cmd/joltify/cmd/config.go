...
const (
	...
	// TODO(GENESIS): `ujolt` is a placeholder for the stake token of the dYdX chain.
	...
	minGasPriceStakeToken = "25000000000ujolt"
...
// JoltAppConfig specifies dYdX app specific config.
type JoltAppConfig struct {
	serverconfig.Config
}
...
func initAppConfig() (string, *JoltAppConfig) {
...
func initTendermintConfig() *tmcfg.Config {
	...
	cfg.Mempool.TTLNumBlocks = 20 //nolint:static-check
