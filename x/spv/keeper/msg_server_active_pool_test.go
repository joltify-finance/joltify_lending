...
func TestActivatePool(t *testing.T) {
	...
	req := types.MsgCreatePool{Creator: "jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0", ProjectIndex: 1, PoolName: "hello", Apy: []string{"7.8", "7.2"}, TargetTokenAmount: sdk.NewCoins(sdk.NewCoin("ausdc", sdk.NewInt(322)), sdk.NewCoin("ausdt", sdk.NewInt(322)))}
