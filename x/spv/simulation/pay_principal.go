...
func SimulateMsgPayPrincipal(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx context.Context, accs []simtypes.Account, chainID string,
		...
		msg := &types.MsgPayPrincipal{
			Creator: simAccount.Address.String(),
		}

		// TODO: Handling the PayPrincipal simulation

		return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "PayPrincipal simulation not implemented"), nil, nil
	}
}
