...
type MsgPayPrincipal struct {
	...
	ExchangeRatio string     `protobuf:"bytes,4,opt,name=exchange_ratio,json=exchangeRatio,proto3" json:"exchange_ratio,omitempty"`
...
func (m *MsgPayPrincipal) GetExchangeRatio() string {
	if m != nil {
...
func (m *MsgPayPrincipal) GetProofUrl() string {
	if m != nil {
		return m.ProofUrl
	}
	return ""
...
func (m *MsgPayPrincipalPartial) GetExchangeRatio() string {
	if m != nil {
		return m.ExchangeRatio
	}
	return ""
...
func (m *MsgPayPrincipalPartial) GetProofUrl() string {
	if m != nil {
		return m.ProofUrl
	}
	return ""
...
var fileDescriptor_7c17332ebde3e0ca = []byte{
	...
	,
}
...
func (m *MsgPayPrincipal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProofUrl) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.ProofUrl)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ExchangeRatio) > 0 {
		i -= len(m.ExchangeRatio)
		copy(dAtA[i:], m.ExchangeRatio)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ExchangeRatio)))
		i--
		dAtA[i] = 0x22
	}
	{
...
func (m *MsgPayPrincipal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ExchangeRatio = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
