...
type LiquidationInfo struct {
	PoolIndex             string                                   `protobuf:"bytes,1,opt,name=pool_index,json=poolIndex,proto3" json:"pool_index,omitempty"`
	EscrowPrincipalAmount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=escrow_principal_amount,json=escrowPrincipalAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"escrow_principal_amount"`
}

func (m *LiquidationInfo) Reset()         { *m = LiquidationInfo{} }
func (m *LiquidationInfo) String() string { return proto.CompactTextString(m) }
func (*LiquidationInfo) ProtoMessage()    {}
func (*LiquidationInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_353391ba5ffe1b1b, []int{3}
}
func (m *LiquidationInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LiquidationInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LiquidationInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LiquidationInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LiquidationInfo.Merge(m, src)
}
func (m *LiquidationInfo) XXX_Size() int {
	return m.Size()
}
func (m *LiquidationInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_LiquidationInfo.DiscardUnknown(m)
}

var xxx_messageInfo_LiquidationInfo proto.InternalMessageInfo

func (m *LiquidationInfo) GetPoolIndex() string {
	if m != nil {
		return m.PoolIndex
	}
	return ""
...
func (m *LiquidationInfo) GetEscrowPrincipalAmount() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.EscrowPrincipalAmount
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LiquidationInfo)(nil), "joltify.spv.LiquidationInfo")
}
...
var fileDescriptor_353391ba5ffe1b1b = []byte{
	...
	,
}
...
func (m *LiquidationInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LiquidationInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LiquidationInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EscrowPrincipalAmount) > 0 {
		for iNdEx := len(m.EscrowPrincipalAmount) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.EscrowPrincipalAmount[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *LiquidationInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.EscrowPrincipalAmount) > 0 {
		for _, e := range m.EscrowPrincipalAmount {
			l = e.Size()
			n += 1 + l + sovPoolinfo(uint64(l))
		}
	}
...
func (m *LiquidationInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LiquidationInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LiquidationInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.EscrowPrincipalAmount = append(m.EscrowPrincipalAmount, types.Coin{})
			if err := m.EscrowPrincipalAmount[len(m.EscrowPrincipalAmount)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
