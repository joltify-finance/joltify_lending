...
// source: joltify/third_party/dydxprotocol/sending/tx.proto
...
func (*MsgCreateTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce3269145945d988, []int{0}
}
...
func (*MsgCreateTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce3269145945d988, []int{1}
}
...
func (*MsgDepositToSubaccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce3269145945d988, []int{2}
}
...
func (*MsgWithdrawFromSubaccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce3269145945d988, []int{3}
}
...
func (*MsgSendFromModuleToAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce3269145945d988, []int{4}
}
...
func init() {
	proto.RegisterType((*MsgCreateTransfer)(nil), "joltify.third_party.dydxprotocol.sending.MsgCreateTransfer")
	proto.RegisterType((*MsgCreateTransferResponse)(nil), "joltify.third_party.dydxprotocol.sending.MsgCreateTransferResponse")
	proto.RegisterType((*MsgDepositToSubaccountResponse)(nil), "joltify.third_party.dydxprotocol.sending.MsgDepositToSubaccountResponse")
	proto.RegisterType((*MsgWithdrawFromSubaccountResponse)(nil), "joltify.third_party.dydxprotocol.sending.MsgWithdrawFromSubaccountResponse")
	proto.RegisterType((*MsgSendFromModuleToAccountResponse)(nil), "joltify.third_party.dydxprotocol.sending.MsgSendFromModuleToAccountResponse")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/sending/tx.proto", fileDescriptor_ce3269145945d988)
}

var fileDescriptor_ce3269145945d988 = []byte{
	...
	,
}
...
func (c *msgClient) CreateTransfer(ctx context.Context, in *MsgCreateTransfer, opts ...grpc.CallOption) (*MsgCreateTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.sending.Msg/CreateTransfer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DepositToSubaccount(ctx context.Context, in *MsgDepositToSubaccount, opts ...grpc.CallOption) (*MsgDepositToSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.sending.Msg/DepositToSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawFromSubaccount(ctx context.Context, in *MsgWithdrawFromSubaccount, opts ...grpc.CallOption) (*MsgWithdrawFromSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.sending.Msg/WithdrawFromSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SendFromModuleToAccount(ctx context.Context, in *MsgSendFromModuleToAccount, opts ...grpc.CallOption) (*MsgSendFromModuleToAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.sending.Msg/SendFromModuleToAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.sending.Msg/CreateTransfer",
	}
...
func _Msg_DepositToSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.sending.Msg/DepositToSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawFromSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.sending.Msg/WithdrawFromSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SendFromModuleToAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.sending.Msg/SendFromModuleToAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "joltify.third_party.dydxprotocol.sending.Msg",
	...
	Metadata: "joltify/third_party/dydxprotocol/sending/tx.proto",
}
