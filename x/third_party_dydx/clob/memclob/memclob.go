...
import (
	...
	indexershared "github.com/joltify-finance/joltify_lending/dydx_helper/indexer/shared"
...
func (m *MemClobPriceTimePriority) PlaceOrder(
	...
	if err != nil {
		if order.IsStatefulOrder() {
			...
			if errors.Is(err, types.ErrFokOrderCouldNotBeFullyFilled) { //nolint
...
func (m *MemClobPriceTimePriority) mustPerformTakerOrderMatching(
	...
	bigTotalMatchedAmount := big.NewInt(0)
