...
// source: joltify/third_party/dydxprotocol/clob/order_removals.proto
...
func (OrderRemoval_RemovalReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_38e0dfa0fdc1a9fb, []int{0, 0}
}
...
type OrderRemoval struct {
	...
	RemovalReason OrderRemoval_RemovalReason `protobuf:"varint,2,opt,name=removal_reason,json=removalReason,proto3,enum=joltify.third_party.dydxprotocol.clob.OrderRemoval_RemovalReason" json:"removal_reason,omitempty"`
}
...
func (*OrderRemoval) Descriptor() ([]byte, []int) {
	return fileDescriptor_38e0dfa0fdc1a9fb, []int{0}
}
...
func init() {
	proto.RegisterEnum("joltify.third_party.dydxprotocol.clob.OrderRemoval_RemovalReason", OrderRemoval_RemovalReason_name, OrderRemoval_RemovalReason_value)
	proto.RegisterType((*OrderRemoval)(nil), "joltify.third_party.dydxprotocol.clob.OrderRemoval")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/clob/order_removals.proto", fileDescriptor_38e0dfa0fdc1a9fb)
}

var fileDescriptor_38e0dfa0fdc1a9fb = []byte{
	// 514 bytes of a gzipped FileDescriptorProto
	,
}
