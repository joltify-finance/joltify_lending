...
type EquityTierLimit struct {
	...
	UsdTncRequired github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,1,opt,name=usd_tnc_required,json=usdTncRequired,proto3,customtype=github.com/joltify-finance/joltify_lending/dydx_helper/dtypes.SerializableInt" json:"usd_tnc_required"`
