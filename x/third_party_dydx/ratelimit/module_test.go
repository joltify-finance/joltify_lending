...
func TestAppModuleBasic_RegisterGRPCGatewayRoutes(t *testing.T) {
	...
	registeredRoutes := []string{
		"/joltify/third_party/dydxprotocol/v4/ratelimit/list_limit_params",
		"/joltify/third_party/dydxprotocol/v4/ratelimit/capacity_by_denom",
	}
	...
	recorder := httptest.NewRecorder()
	req, err := http.NewRequest("GET", "/joltify/third_party/dydxprotocol/v4/ratelimit/foo/bar/baz", nil)
	require.NoError(t, err)
	router.ServeHTTP(recorder, req)
