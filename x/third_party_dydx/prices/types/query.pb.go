...
// source: joltify/third_party/dydxprotocol/prices/query.proto
...
func (*QueryMarketPriceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{0}
}
...
func (*QueryMarketPriceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{1}
}
...
func (*QueryAllMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{2}
}
...
func (*QueryAllMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{3}
}
...
func (*QueryMarketParamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{4}
}
...
func (*QueryMarketParamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{5}
}
...
func (*QueryAllMarketParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{6}
}
...
func (*QueryAllMarketParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c47ae3d4b0bcb24, []int{7}
}
...
func init() {
	proto.RegisterType((*QueryMarketPriceRequest)(nil), "joltify.third_party.dydxprotocol.prices.QueryMarketPriceRequest")
	proto.RegisterType((*QueryMarketPriceResponse)(nil), "joltify.third_party.dydxprotocol.prices.QueryMarketPriceResponse")
	proto.RegisterType((*QueryAllMarketPricesRequest)(nil), "joltify.third_party.dydxprotocol.prices.QueryAllMarketPricesRequest")
	proto.RegisterType((*QueryAllMarketPricesResponse)(nil), "joltify.third_party.dydxprotocol.prices.QueryAllMarketPricesResponse")
	proto.RegisterType((*QueryMarketParamRequest)(nil), "joltify.third_party.dydxprotocol.prices.QueryMarketParamRequest")
	proto.RegisterType((*QueryMarketParamResponse)(nil), "joltify.third_party.dydxprotocol.prices.QueryMarketParamResponse")
	proto.RegisterType((*QueryAllMarketParamsRequest)(nil), "joltify.third_party.dydxprotocol.prices.QueryAllMarketParamsRequest")
	proto.RegisterType((*QueryAllMarketParamsResponse)(nil), "joltify.third_party.dydxprotocol.prices.QueryAllMarketParamsResponse")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/prices/query.proto", fileDescriptor_3c47ae3d4b0bcb24)
}

var fileDescriptor_3c47ae3d4b0bcb24 = []byte{
	// 588 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) MarketPrice(ctx context.Context, in *QueryMarketPriceRequest, opts ...grpc.CallOption) (*QueryMarketPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.prices.Query/MarketPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllMarketPrices(ctx context.Context, in *QueryAllMarketPricesRequest, opts ...grpc.CallOption) (*QueryAllMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.prices.Query/AllMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MarketParam(ctx context.Context, in *QueryMarketParamRequest, opts ...grpc.CallOption) (*QueryMarketParamResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.prices.Query/MarketParam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllMarketParams(ctx context.Context, in *QueryAllMarketParamsRequest, opts ...grpc.CallOption) (*QueryAllMarketParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.prices.Query/AllMarketParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_MarketPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.prices.Query/MarketPrice",
	}
...
func _Query_AllMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.prices.Query/AllMarketPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_MarketParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.prices.Query/MarketParam",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllMarketParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.prices.Query/AllMarketParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "joltify.third_party.dydxprotocol.prices.Query",
	...
	Metadata: "joltify/third_party/dydxprotocol/prices/query.proto",
}
