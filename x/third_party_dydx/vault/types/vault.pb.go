...
type NumShares struct {
	// Number of shares.
	NumShares github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=num_shares,json=numShares,proto3,customtype=github.com/joltify-finance/joltify_lending/dydx_helper/dtypes.SerializableInt" json:"num_shares"`
}
