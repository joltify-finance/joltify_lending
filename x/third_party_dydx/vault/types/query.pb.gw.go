...
var filter_Query_AllVaults_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
var filter_Query_OwnerShares_0 = &utilities.DoubleArray{Encoding: map[string]int{"type": 0, "number": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
