...
func TestState_ShareRecord_JSONEncoding(t *testing.T) {
	...
	assert.Equal(t, "jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0", record.Depositor.String())
	assert.Equal(t, types.PoolID("ukava", "usdx"), record.PoolID)
	assert.Equal(t, i(3e6), record.SharesOwned)
}

func TestState_ShareRecord_YamlEncoding(t *testing.T) {
	expected := `depositor: jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0
pool_id: ukava:usdx
shares_owned: "3000000"
`
	depositor, err := sdk.AccAddressFromBech32("jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0")
	require.NoError(t, err)
...
func TestState_ShareRecord_Validations(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErr: "depositor 'jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0' and pool 'ukava:usdx' has invalid total shares: -1",
		},
		{
			name:        "zero total shares",
			depositor:   validRecord.Depositor,
			...
			expectedErr: "depositor 'jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0' and pool 'ukava:usdx' has invalid total shares: 0",
		},
	}
...
func TestState_ShareRecords_Validation(t *testing.T) {
	...
	err = records.Validate()
	assert.Error(t, err)
	assert.EqualError(t, err, "depositor 'jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0' and pool 'hard:usdx' has invalid total shares: -1")
}

func TestState_ShareRecords_ValidateUniqueShareRecords(t *testing.T) {
	depositor_1, err := sdk.AccAddressFromBech32("jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0")
	require.NoError(t, err)

	depositor_2, err := sdk.AccAddressFromBech32("jolt1q64lk39jn0afjvvh2zh2l8tzeu36mj4yky876c")
	require.NoError(t, err)
	...
	assert.EqualError(t, invalidRecords.Validate(), "duplicate depositor 'jolt1txtsnx4gr4effr8542778fsxc20j5vzqxet7t0' and poolID 'ukava:usdx'")
}
