...
func GetCmdIssueTokens() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s tx %s issue 20000000usdtoken jolt1cwhfwfysc4l5guwpffc5ttgvm9dky5snzqt6aa
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types2.NewMsgIssueTokens(cliCtx.GetFromAddress().String(), tokens, receiver.String())
...
func GetCmdRedeemTokens() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types2.NewMsgRedeemTokens(cliCtx.GetFromAddress().String(), tokens)
			err = msg.ValidateBasic()
			if err != nil {
				return err
			}
...
func GetCmdBlockAddress() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s tx %s block jolt1cwhfwfysc4l5guwpffc5ttgvm9dky5snzqt6aa usdtoken
		`, version.AppName, types2.ModuleName),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx, err := client.GetClientTxContext(cmd)
			...
			msg := types2.NewMsgBlockAddress(cliCtx.GetFromAddress().String(), args[1], address.String())
			err = msg.ValidateBasic()
			if err != nil {
				return err
			}
...
func GetCmdUnblockAddress() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s tx %s unblock jolt1cwhfwfysc4l5guwpffc5ttgvm9dky5snzqt6aa usdtoken
		`, version.AppName, types2.ModuleName),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx, err := client.GetClientTxContext(cmd)
			...
			msg := types2.NewMsgUnblockAddress(cliCtx.GetFromAddress().String(), args[1], address.String())
			err = msg.ValidateBasic()
			if err != nil {
				return err
			}
...
func GetCmdPauseAsset() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types2.NewMsgSetPauseStatus(cliCtx.GetFromAddress().String(), args[0], status)
			err = msg.ValidateBasic()
			if err != nil {
				return err
			}
