...
import (
	...
	v015issuance "github.com/joltify-finance/joltify_lending/x/third_party/issuance/legacy/v0_15"
	v016issuance "github.com/joltify-finance/joltify_lending/x/third_party/issuance/types"
...
func (s *migrateTestSuite) TestMigrate_JSON() {
	...
	data := `{
			...
			"assets": [
				{
					...
					"denom": "hbtc",
					"owner": "jolt10wlnqzyss4accfqmyxwx5jy5x9nfkwh6kwhjs9",
					"paused": false,
					"rate_limit": {
						"active": false,
						"limit": "0",
		...
		"supplies": [
			{
				"current_supply": { "denom": "ujolt", "amount": "100" },
...
func (s *migrateTestSuite) TestMigrate_Supplies() {
	s.v15genstate.Supplies = v015issuance.AssetSupplies{
		{
			CurrentSupply: sdk.NewCoin("ujolt", sdk.NewInt(100)),
