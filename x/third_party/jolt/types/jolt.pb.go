...
type Params struct {
	...
	MinimumBorrowUSDValue   cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=minimum_borrow_usd_value,json=minimumBorrowUsdValue,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"minimum_borrow_usd_value"`
	SurplusAuctionThreshold cosmossdk_io_math.Int       `protobuf:"bytes,3,opt,name=surplus_auction_threshold,json=surplusAuctionThreshold,proto3,customtype=cosmossdk.io/math.Int" json:"surplus_auction_threshold"`
}
...
type MoneyMarket struct {
	...
	ConversionFactor       cosmossdk_io_math.Int       `protobuf:"bytes,4,opt,name=conversion_factor,json=conversionFactor,proto3,customtype=cosmossdk.io/math.Int" json:"conversion_factor"`
	...
	ReserveFactor          cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=reserve_factor,json=reserveFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"reserve_factor"`
	KeeperRewardPercentage cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=keeper_reward_percentage,json=keeperRewardPercentage,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"keeper_reward_percentage"`
}
...
type BorrowLimit struct {
	...
	MaximumLimit cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=maximum_limit,json=maximumLimit,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"maximum_limit"`
	LoanToValue  cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=loan_to_value,json=loanToValue,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"loan_to_value"`
}
...
type InterestRateModel struct {
	BaseRateAPY    cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=base_rate_apy,json=baseRateApy,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"base_rate_apy"`
	BaseMultiplier cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=base_multiplier,json=baseMultiplier,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"base_multiplier"`
	Kink           cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=kink,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"kink"`
	JumpMultiplier cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=jump_multiplier,json=jumpMultiplier,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"jump_multiplier"`
}
...
var fileDescriptor_ad0a5b866fb81872 = []byte{
	...
	,
}
