	...
	t.Run("calculateNewRewards", func(t *testing.T) {
		...
		testcases := []struct {
		...
		}{
			{
				...
				args: args{
					rewardsPerSecond:  cs(c("jolt", 1000), c("swap", 100)),
					duration:          10 * time.Second,
					totalSourceShares: d("1000"),
				},
				expected: RewardIndexes{
					{CollateralType: "jolt", RewardFactor: d("10").MulInt64(1e12)},
					{CollateralType: "swap", RewardFactor: d("1").MulInt64(1e12)},
				},
			},
			{
				name: "duration is rounded to nearest even second",
				args: args{
					rewardsPerSecond:  cs(c("jolt", 1000)),
			...
			},
			{
				...
				expected: RewardIndexes{
					...
					{CollateralType: "anydenom", RewardFactor: d("0.000000000000000010").MulInt64(1e12)},
				},
			},
			{
		...
		testcases := []struct {
		...
		}{
			{
				...
				args: args{
					accumulator: Accumulator{
						...
						Indexes: RewardIndexes{
							{CollateralType: "jolt", RewardFactor: d("0.1").MulInt64(1e12)},
							{CollateralType: "swap", RewardFactor: d("0.2").MulInt64(1e12)},
						},
					},
					period: MultiRewardPeriod{
				...
				expected: Accumulator{
					...
					Indexes: RewardIndexes{
						{CollateralType: "jolt", RewardFactor: d("5.1").MulInt64(1e12)},
						{CollateralType: "swap", RewardFactor: d("0.2").MulInt64(1e12)},
					},
				},
			},
			{
				...
				expected: Accumulator{
					PreviousAccumulationTime: time.Date(1998, 1, 1, 0, 0, 5, 0, time.UTC),
					Indexes:                  RewardIndexes{{CollateralType: "jolt", RewardFactor: d("5.0").MulInt64(1e12)}},
				},
			},
			{
			...
			},
			{
				...
				args: args{
					accumulator: Accumulator{
						PreviousAccumulationTime: time.Date(1998, 1, 1, 0, 0, 0, 0, time.UTC),
						Indexes:                  RewardIndexes{{CollateralType: "jolt", RewardFactor: d("0.1").MulInt64(1e12)}},
					},
					period: MultiRewardPeriod{
				...
				expected: Accumulator{
					...
					Indexes:                  RewardIndexes{{CollateralType: "jolt", RewardFactor: d("2.1").MulInt64(1e12)}},
				},
			},
			{
				...
				expected: Accumulator{
					...
					Indexes:                  RewardIndexes{{CollateralType: "jolt", RewardFactor: d("10.1").MulInt64(1e12)}},
				},
			},
		}
