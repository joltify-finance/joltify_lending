...
// MsgClaimJoltReward message type used to claim Jolt liquidity provider rewards
...
- Accumulated rewards for active claims are transferred from the `mint` module account to the users account as vesting coins
