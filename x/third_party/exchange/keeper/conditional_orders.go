...
func (k *Keeper) GetAllSubaccountConditionalOrders(
	...
	marketID common.Hash,
	subaccountID common.Hash,
) []*types.TrimmedDerivativeConditionalOrder {
	trimmedMarketOrder := func(orderHash common.Hash, isTriggerPriceHigher bool) *types.TrimmedDerivativeConditionalOrder {
	...
	trimmedLimitOrder := func(orderHash common.Hash, isTriggerPriceHigher bool) *types.TrimmedDerivativeConditionalOrder {
