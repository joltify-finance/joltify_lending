...
func (k Keeper) GetMarkets(ctx sdk.Context) types2.Markets {
...
func (k Keeper) GetOracles(ctx sdk.Context, marketID string) ([]sdk.AccAddress, error) {
	...
	return nil, sdkerrors.Wrap(types2.ErrInvalidMarket, marketID)
}
...
func (k Keeper) GetOracle(ctx sdk.Context, marketID string, address sdk.AccAddress) (sdk.AccAddress, error) {
	...
	return nil, sdkerrors.Wrap(types2.ErrInvalidOracle, address.String())
}

// GetMarket returns the market if it is in the pricefeed system
func (k Keeper) GetMarket(ctx sdk.Context, marketID string) (types2.Market, bool) {
