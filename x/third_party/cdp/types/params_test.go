...
func (suite *ParamsTestSuite) TestParamValidation() {
	...
	testCases := []struct {
	...
	}{
		{
			name: "default",
			args: args{
				globalDebtLimit:  types2.DefaultGlobalDebt,
				collateralParams: types2.DefaultCollateralParams,
				debtParam:        types2.DefaultDebtParam,
				surplusThreshold: types2.DefaultSurplusThreshold,
				surplusLot:       types2.DefaultSurplusLot,
				debtThreshold:    types2.DefaultDebtThreshold,
				debtLot:          types2.DefaultDebtLot,
				breaker:          types2.DefaultCircuitBreaker,
			},
			errArgs: errArgs{
				expectPass: true,
				contains:   "",
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			params := types2.NewParams(tc.args.globalDebtLimit, tc.args.collateralParams, tc.args.debtParam, tc.args.surplusThreshold, tc.args.surplusLot, tc.args.debtThreshold, tc.args.debtLot, tc.args.breaker)
			err := params.Validate()
