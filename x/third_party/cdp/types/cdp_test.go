...
func (suite *CdpValidationSuite) TestCdpValidation() {
	...
	testCases := []struct {
		...
		{
			name: "valid cdp",
			cdp:  types2.NewCDP(1, suite.addrs[0], sdk.NewInt64Coin("bnb", 100000), "bnb-a", sdk.NewInt64Coin("usdx", 100000), tmtime.Now(), sdk.OneDec()),
			errArgs: errArgs{
				expectPass: true,
				msg:        "",
			},
		...
		{
			name: "invalid cdp id",
			cdp:  types2.NewCDP(0, suite.addrs[0], sdk.NewInt64Coin("bnb", 100000), "bnb-a", sdk.NewInt64Coin("usdx", 100000), tmtime.Now(), sdk.OneDec()),
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types2.CDP{1, suite.addrs[0], "bnb-a", sdk.Coin{"", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(0)}, tmtime.Now(), sdk.OneDec()},
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types2.CDP{1, suite.addrs[0], "xrp-a", sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(0)}, tmtime.Now(), sdk.OneDec()},
			errArgs: errArgs{
				expectPass: false,
		...
		{
			name: "invalid fees",
			cdp:  types2.CDP{1, suite.addrs[0], "xrp-a", sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(100)}, sdk.Coin{"", sdk.NewInt(0)}, tmtime.Now(), sdk.OneDec()},
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types2.CDP{1, suite.addrs[0], "xrp-a", sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(0)}, time.Time{}, sdk.OneDec()},
			errArgs: errArgs{
				expectPass: false,
		...
		{
			name: "invalid type",
			cdp:  types2.CDP{1, suite.addrs[0], "", sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(100)}, sdk.Coin{"usdx", sdk.NewInt(0)}, tmtime.Now(), sdk.OneDec()},
			errArgs: errArgs{
				expectPass: false,
...
func (suite *CdpValidationSuite) TestDepositValidation() {
	...
	testCases := []struct {
		...
		{
			name:    "valid deposit",
			deposit: types2.NewDeposit(1, suite.addrs[0], sdk.NewInt64Coin("bnb", 1000000)),
			errArgs: errArgs{
				expectPass: true,
				msg:        "",
			},
		...
		{
			name:    "invalid cdp id",
			deposit: types2.NewDeposit(0, suite.addrs[0], sdk.NewInt64Coin("bnb", 1000000)),
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			deposit: types2.NewDeposit(1, sdk.AccAddress{}, sdk.NewInt64Coin("bnb", 1000000)),
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			deposit: types2.NewDeposit(1, suite.addrs[0], sdk.Coin{Denom: "Invalid Denom", Amount: sdk.NewInt(1000000)}),
			errArgs: errArgs{
				expectPass: false,
...
func (suite *CdpValidationSuite) TestCdpGetTotalPrinciple() {
	...
	cdp := types2.CDP{Principal: principal, AccumulatedFees: accumulatedFees}
