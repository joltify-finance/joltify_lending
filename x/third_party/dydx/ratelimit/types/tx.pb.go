...
// source: joltify/third_party/dydxprotocol/ratelimit/tx.proto
...
func (*MsgSetLimitParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f46420d091f9f9c, []int{0}
}
...
func (*MsgSetLimitParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f46420d091f9f9c, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSetLimitParams)(nil), "joltify.third_party.dydxprotocol.ratelimit.MsgSetLimitParams")
	proto.RegisterType((*MsgSetLimitParamsResponse)(nil), "joltify.third_party.dydxprotocol.ratelimit.MsgSetLimitParamsResponse")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/ratelimit/tx.proto", fileDescriptor_9f46420d091f9f9c)
}

var fileDescriptor_9f46420d091f9f9c = []byte{
	...
	,
}
...
func (c *msgClient) SetLimitParams(ctx context.Context, in *MsgSetLimitParams, opts ...grpc.CallOption) (*MsgSetLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.ratelimit.Msg/SetLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.ratelimit.Msg/SetLimitParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "joltify.third_party.dydxprotocol.ratelimit.Msg",
	...
	Metadata: "joltify/third_party/dydxprotocol/ratelimit/tx.proto",
}
