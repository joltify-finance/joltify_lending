...
import (
	...
	"github.com/joltify-finance/joltify_lending/x/third_party/dydx/clob/client/cli"
...
// AppModuleBasic implements the AppModuleBasic interface for the clob module.
...
// GetTxCmd returns the clob module's root tx command.
func (a AppModuleBasic) GetTxCmd() *cobra.Command {
	return cli.GetTxCmd()
}

// GetQueryCmd returns the clob module's root query command.
...
// AppModule implements the AppModule interface for the clob module.
