...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"joltify", "third_party", "dydxprotocol", "vault", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Vault_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"joltify", "third_party", "dydxprotocol", "vault", "type", "number"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AllVaults_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 3}, []string{"joltify", "third_party", "dydxprotocol", "vault"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OwnerShares_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"joltify", "third_party", "dydxprotocol", "vault", "owner_shares", "type", "number"}, "", runtime.AssumeColonVerbOpt(false)))
)
