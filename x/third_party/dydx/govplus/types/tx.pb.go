...
// source: joltify/third_party/dydxprotocol/govplus/tx.proto
...
type MsgSlashValidator struct {
	...
	// this.
	TokensAtInfractionHeight github_com_joltify_third_party_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=tokens_at_infraction_height,json=tokensAtInfractionHeight,proto3,customtype=github.com/joltify/third_party/dydxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"tokens_at_infraction_height"`
...
func (*MsgSlashValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_e65cf49a566fd666, []int{0}
}
...
func (*MsgSlashValidatorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e65cf49a566fd666, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSlashValidator)(nil), "joltify.third_party.dydxprotocol.govplus.MsgSlashValidator")
	proto.RegisterType((*MsgSlashValidatorResponse)(nil), "joltify.third_party.dydxprotocol.govplus.MsgSlashValidatorResponse")
}

func init() {
	proto.RegisterFile("joltify/third_party/dydxprotocol/govplus/tx.proto", fileDescriptor_e65cf49a566fd666)
}

var fileDescriptor_e65cf49a566fd666 = []byte{
	// 523 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) SlashValidator(ctx context.Context, in *MsgSlashValidator, opts ...grpc.CallOption) (*MsgSlashValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/joltify.third_party.dydxprotocol.govplus.Msg/SlashValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SlashValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/joltify.third_party.dydxprotocol.govplus.Msg/SlashValidator",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "joltify.third_party.dydxprotocol.govplus.Msg",
	...
	Metadata: "joltify/third_party/dydxprotocol/govplus/tx.proto",
}
