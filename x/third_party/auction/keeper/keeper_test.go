...
func TestIterateAuctions(t *testing.T) {
	...
	auctions := []types2.Auction{
		...
		types2.NewDebtAuction("buyerMod", c("denom", 12345678), c("anotherdenom", 12345678), time.Date(1998, time.January, 1, 0, 0, 0, 0, time.UTC), c("debt", 12345678)).WithID(1),
		types2.NewCollateralAuction("sellerMod", c("denom", 12345678), time.Date(1998, time.January, 1, 0, 0, 0, 0, time.UTC), c("anotherdenom", 12345678), types2.WeightedAddresses{}, c("debt", 12345678)).WithID(2),
	}
	...
	// run
	var readAuctions []types2.Auction
