...
type HistoricalDistInfo struct {
	...
	DistributedRound uint64    `protobuf:"varint,2,opt,name=distributed_round,json=distributedRound,proto3" json:"distributed_round,omitempty"`
}
...
func (m *HistoricalDistInfo) GetDistributedRound() uint64 {
	if m != nil {
		return m.DistributedRound
	}
	return 0
}
...
var fileDescriptor_fcf5df87643c0477 = []byte{
	...
	,
}
...
func (m *HistoricalDistInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DistributedRound != 0 {
		i = encodeVarintDist(dAtA, i, uint64(m.DistributedRound))
		i--
		dAtA[i] = 0x10
	}
...
func (m *HistoricalDistInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DistributedRound", wireType)
			}
			m.DistributedRound = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDist
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DistributedRound |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
